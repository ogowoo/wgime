...
python wgime-py-pure\tests\dsl-verbs-test.py        # 步骤 DSL 动词: start(拉起常驻程序且不等退出)/run 对照/相对路径与 %WGIME_DIR%/两侧动词表不许漂移(43 项，§32)
```
