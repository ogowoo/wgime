...
python wgime-py-pure\tests\pet-overlay-test.py       # 桌面宠物浮层：穿透/不抢焦点/真透明/交互态点工具 + 三场景 + 宿主 API 路径（72 项，无桌面只跑 S，§49/§D37/§D38/§D39）
```
